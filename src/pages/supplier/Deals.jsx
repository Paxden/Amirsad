...
const SupplierDeals = () => {
  ...
  return (
    <div>
      <PageHeader
        title="My Deals"
        breadcrumbs={[{ label: "Supplier" }, { label: "Deals" }]}
        actions={
          ...
          <Row className="g-3">
            <Col md={5}>
              <InputGroup>
                ...
                <Form.Control
                  type="text"
                  placeholder="Search by deal number or buyer name..."
                  ...
                  <td>
                    <div className="min-width-100">
                      ...
                      <small className="text-muted">
                        {Math.round(getProgressPercentage(deal))}%
                      </small>
                    </div>
                  </td>
                  <td>
            ...
            <div>
              ...
              <div className="bg-light p-3 rounded mb-4">
                <Row>
                  <Col md={6}>
                    <strong>Name:</strong>
                    <p>{selectedDeal.buyer?.fullName}</p>
                  </Col>
                  <Col md={6}>
                    <strong>Email:</strong>
                    <p>{selectedDeal.buyer?.email}</p>
                  </Col>
                  <Col md={6}>
                    <strong>Phone:</strong>
                    <p>{selectedDeal.buyer?.phone || "N/A"}</p>
                  </Col>
                  <Col md={6}>
                    <strong>Company:</strong>
                    <p>{selectedDeal.buyer?.profile?.companyName || "N/A"}</p>
                  </Col>
                </Row>
              </div>
                  ...
                  <div className="bg-light p-3 rounded mb-4">
                    <Row>
                      <Col md={4}>
                        ...
                        <Badge
                          bg={
                            selectedDeal.payment.status === "paid"
                              ? "success"
                              : "warning"
                          }
                          className="ms-2"
                  ...
                  <div className="bg-light p-3 rounded mb-4">
                    <Row>
                      ...
                      <Col md={6}>
                        ...
                        <p>
                          {selectedDeal.delivery.scheduledDate
                            ? new Date(
                                selectedDeal.delivery.scheduledDate,
                              ).toLocaleDateString()
                            : "Not scheduled"}
              ...
              <div className="bg-light p-3 rounded">
                {selectedDeal.statusHistory &&
                selectedDeal.statusHistory.length > 0 ? (
                  ...
                  <div className="mt-1">
                    {[...Array(5)].map((_, i) => (
                      <FiStar
                        ...
                        size={16}
                        className={
                          i < selectedDeal.buyerRating.rating
                            ? "text-warning"
                            : "text-muted"
                        }
                    ...
                    <p className="mt-1 small">
                      {selectedDeal.buyerRating.feedback}
                    </p>
                  </div>
                </Alert>
              )}
      ...
      <Modal show={showRatingModal} onHide={() => setShowRatingModal(false)}>
        <Modal.Header closeButton>
          <Modal.Title>Rate Buyer</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
            How was your experience with{" "}
            <strong>{selectedDeal?.buyer?.fullName}</strong>?
          </p>
          <Form>
              ...
              <div className="d-flex gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <FiStar
                    ...
                    size={30}
                    className={
                      star <= ratingData.rating ? "text-warning" : "text-muted"
                    }
        ...
        <Modal.Footer>
          ...
          <Button variant="warning" onClick={handleRateBuyer}>
            Submit Rating
          </Button>
        </Modal.Footer>
      </Modal>
